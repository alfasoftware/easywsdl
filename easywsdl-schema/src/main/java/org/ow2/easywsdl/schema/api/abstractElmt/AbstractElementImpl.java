 ...
 */
public abstract class AbstractElementImpl<E, T extends AbsItfType> extends
		AbstractSchemaElementImpl<E> implements AbsItfElement<T> {
	 ...
	 * @param parent
	 */
	public AbstractElementImpl(final E model,
